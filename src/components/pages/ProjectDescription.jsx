...
const ProjectDescription = () => {
  return (
    <AppContainer>
      <Sidebar />
      <PageContent className={"flex flex-col items-start"}>
        ...
        <p>
          ...
          โปรเจกต์นี้พัฒนาภายใต้แนวคิด “สร้างสภาพแวดล้อมที่ปลอดภัยด้วยเทคโนโลยี
          AI” โดยนำ Computer Vision และโมเดล AI ที่ถูกฝึกฝนมาแล้ว
          มาใช้ในการวิเคราะห์ภาพ โดยไม่ใช้การเชื่อมต่อแบบ WebRTC
          ภาพจากกล้องจะถูกประมวลผลบนฝั่งผู้ใช้งาน (Frontend) ก่อนส่งผ่าน API
          ไปยัง Backend Server ที่พัฒนาในภาษา Python เพื่อให้โมเดล AI วิเคราะห์
          และส่งผลลัพธ์กลับมาแสดงบนหน้าเว็บแบบทันที
